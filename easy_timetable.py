...
day = int(input())
if day == 1:
    file = pd.read_excel('FAST School of Computing Spring 2023- V2.xlsx', sheet_name='MONDAY')
elif day == 2:
    file = pd.read_excel('FAST School of Computing Spring 2023- V2.xlsx', sheet_name='TUESDAY')
elif day == 3:
    file = pd.read_excel('FAST School of Computing Spring 2023- V2.xlsx', sheet_name='WEDNESDAY')
elif day == 4:
    file = pd.read_excel('FAST School of Computing Spring 2023- V2.xlsx', sheet_name='THURSDAY')
elif day == 5:
    file = pd.read_excel('FAST School of Computing Spring 2023- V2.xlsx', sheet_name='FRIDAY')
